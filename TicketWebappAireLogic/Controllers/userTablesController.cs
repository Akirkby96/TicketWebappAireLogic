...
namespace TicketWebappAireLogic.Controllers
{
    public class userTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "userID,userName,userRole")] userTable userTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "userID,userName,userRole")] userTable userTable)
        {
            if (ModelState.IsValid)
            {
